...
const Orders = () => {
  ...
  return (
    <section className="py-24 relative">
      {allOrders && <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
        <h2 className="font-manrope font-bold text-4xl leading-10 text-black text-center">
          Orders you made
        </h2>
        <p className="mt-4 font-normal text-lg leading-8 text-gray-500 mb-11 text-center">Orders that you have made pending or delivered.</p>
        {allOrders.map((order) => <div key={order._id} className="main-box border my-3 border-gray-200 rounded-xl pt-6 max-w-xl max-lg:mx-auto lg:max-w-full">
            <div
              ...
              <button
                className="rounded-full py-3 px-7 font-semibold text-sm leading-7 text-white bg-indigo-600 max-lg:mt-5 shadow-sm shadow-transparent transition-all duration-500 hover:bg-indigo-700 hover:shadow-indigo-400">Track Your Order</button>
            </div>
            <div className="w-full px-3 min-[400px]:px-6">
              {order.products.map((product) => <div key={product.id} className="flex flex-col lg:flex-row items-center py-6 border-b border-gray-200 gap-6 w-full">
                <div className="img-box max-lg:w-full">
                  <img src={product.pic} alt="Premium Watch image"
                      ...
                      <div className="">
                        ...
                        <div className="flex items-center ">
                          ...
                          <p className="font-medium text-base leading-7 text-black ">Qty: <span
                            className="text-gray-500">{product.qty}</span></p>
                        </div>
                      </div>
                    </div>
